        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "The one with the cethedral that was never really finished.", "Antwerp" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 2, "A Gothic style cathedral, concieved by architect Jan and Pieter.", "Cathedral of Our Lady" },
                    { 4, 2, "The finest example of railway architecture in Belgium.", "Antwerp Central Station" },
                    { 5, 3, "A wrought iron lattice tower on the Champ de Mars in Paris.", "Eiffel Tower" },
                    { 6, 3, "The world's most famous art museum.", "The Louvre" }
                });
        }
